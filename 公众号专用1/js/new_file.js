...
(function($, window) {
	var jly_publicNum = function() {
		this.yanguang = function(callback) {

			$('body').append($('<div class="jly_qiuzhujingChoice"><ul class="jly_RLChange" type ="R"><li><img src="./imgs/R.png" alt=""></li><li><img src="./imgs/L.png" alt=""></li></ul><ul class="clearfix jly_qiuzhujingChoseBox" now="0"><li><p class="jly_typeTitle">球镜SPH</p><div class="jly_picker"><ul class="jly_pickerMask" name="SPH" num="2" arr="qjArr" value="+0.00"><li class="jly_tran1"></li><li class="jly_tran2"></li><li class="jly_thisValue"></li><li class="jly_tran2"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView"></ol></div><p class="jly_typeTitle jly_mt3">瞳距（PD）<i class="jly_checkBtn  jly_separate "></i></p><div class="jly_picker jly_picker3"><ul class="jly_pickerMask" name="PD" num="1" arr="pdArr" value="15.00"><li class="jly_tran1"></li><li class="jly_thisValue"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView tongju"></ol></div></li><li><p class="jly_typeTitle">柱镜CYL</p><div class="jly_picker"><ul class="jly_pickerMask" name="CYL" value="+0.00" num="2" arr="zjArr"><li class="jly_tran1"></li><li class="jly_tran2"></li><li class="jly_thisValue"></li><li class="jly_tran2"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView"></ol></div><p class="jly_typeTitle">轴位(AX)</p><div class="jly_dashboard"><div class="jly_plus jly_fuhao noselect"></div><div class="jly_reduce jly_fuhao noselect"></div><div class="jly_mark"></div></div><div class="jly_showRound">0</div></li><li><p class="jly_typeTitle">下加光ADD</p><div class="jly_picker"><ul class="jly_pickerMask" name="ADD" value="0.75" num="2" arr="addArr"><li class="jly_tran1"></li><li class="jly_tran2"></li><li class="jly_thisValue"></li><li class="jly_tran2"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView"></ol></div><div class="jly_twopicker"><div class="jingyong jly_oncePick"><p class="jly_typeTitle jly_mt3">近用瞳距(PD)<i class="jly_checkChose"></i></p><div class="jly_picker jly_picker3"><ul class="jly_pickerMask" name="jingyong" num="1" arr="jingyongArr" value="16.00"><li class="jly_tran1"></li><li class="jly_thisValue"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView"></ol></div></div><div class="tonggao jly_oncePick"><p class="jly_typeTitle jly_mt3">瞳高(VD)<i class="jly_checkChose"></i></p><div class="jly_picker jly_picker3"><ul class="jly_pickerMask" name="VD" num="1" arr="vdArr" value="31"><li class="jly_tran1"></li><li class="jly_thisValue"></li><li class="jly_tran1"></li></ul><ol class="jly_pickView"></ol></div></div></div></li></ul><div class="jly_bottomBtn"><div class="jly_picker_btn fl jly_picker_cancel">取消</div><div class="jly_picker_btn fl jly_confirm">确定</div></div></div>'));
			...
			while(demoPd <= 49.5) {
				pdArr.push(demoPd.toFixed(2));
				jingyongArr.push(demoPd.toFixed(2));
				demoPd += .5;
			}
			while(demoAdd <= 6) {
			...
			//创建picker选择项
			//jly_picker 选项渲染
			var w1 = html.getBoundingClientRect().width / 10 * .9;
			renderPicker()
			...
			$('.jly_pickerMask').on('touchstart', function(e1) {
				//获取1rem 的大小;
				w1 = html.getBoundingClientRect().width / 10 * .9;
				e1.preventDefault();
				e1.stopPropagation();
			...
			$('.jly_dashboard').on('touchstart', function(e) {
				...
				$(this).find('.jly_mark').css('transform', 'translateY(-.192rem) rotate(' + round + 'deg)');
			...
			$('.jly_fuhao').on('touchstart', function(e) {
				...
				$(this).parent().find('.jly_mark').css('transform', 'translateY(-.192rem) rotate(' + round + 'deg)');
				$('.jly_showRound').text(Math.abs(round));
				obj[$('.jly_RLChange').attr('type')].AX = Math.abs(round);
				console.log(obj);
			...
			function render(obj) {
				...
				$('.jly_dashboard').find('.jly_mark').css('transform', 'translateY(-.192rem) rotate(-' + nowObj.AX + 'deg)');
