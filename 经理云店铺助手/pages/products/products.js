...
//下拉刷新
    ...
    wx.scanCode({
      ...
      success: function (res) {
        ...
        if (res.result) {
          ...
          //请求商品---start
          wx.request({
            url: 'https://www.jingliyun.cn/index.php/Home/SmallProgram/ScanSale',
            data: {
              code: code,
              store_id: store_id
            },
            ...
            success: function (res) {
              ...
              if(res.data.code==200){
                ...
                var product_item = {}
                product_item.price = res.data.data[0].price
                product_item.numbers = res.data.data[0].numbers
                product_item.number = 1
                product_item.stock_imgPath = res.data.data[0].stock_imgPath
                product_item.degree_id = res.data.data[0].degree_id
                product_item.stock_type = res.data.data[0].stock_type
                product_item.number_id = res.data.data[0].number_id
                product_item.urlcode = code
                product_item.stock_integral = res.data.data[0].stock_integral
                switch (res.data.data[0].stock_type) {
                  case 1:
                    product_item.lens_brand = res.data.data[0].lens_brand
                    product_item.lens_refractivity = res.data.data[0].lens_refractivity
                    product_item.degree_cyl = res.data.data[0].degree_cyl

                    product_item.lens_colorFilm = res.data.data[0].lens_colorFilm
                    product_item.lens_model = res.data.data[0].lens_model
                    product_item.lens_material = res.data.data[0].lens_material
                    product_item.lens_function = res.data.data[0].lens_function
                    product_item.len = res.data.data[0].o1
                    break;
                  case 2:
                    product_item.gframe_brand = res.data.data[0].gframe_brand

                    product_item.gframe_model = res.data.data[0].gframe_model
                    product_item.gframe_style = res.data.data[0].gframe_style + res.data.data[0].degree_colorNumber
                    product_item.gframe_material = res.data.data[0].gframe_brand
                    break;
                  case 3:
                    product_item.sun_brand = res.data.data[0].sun_brand

                    product_item.sun_model = res.data.data[0].sun_model
                    product_item.sun_style = res.data.data[0].sun_style + res.data.data[0].degree_colorNumber
                    product_item.sun_material = res.data.data[0].sun_material
                    break;
                  case 4:
                    product_item.presbyopic_brand = res.data.data[0].presbyopic_brand
                    product_item.degree_cyl = res.data.data[0].degree_cyl

                    product_item.presbyopic_model = res.data.data[0].presbyopic_model
                    product_item.presbyopic_style = res.data.data[0].presbyopic_style
                    product_item.presbyopic_frameMaterial = res.data.data[0].presbyopic_frameMaterial
                    break;
                  case 5:
                    product_item.contact_brand = res.data.data[0].contact_brand
                    product_item.contact_watercontent = res.data.data[0].contact_watercontent
                    product_item.degree_cyl = res.data.data[0].degree_cyl

                    product_item.contact_usetime = res.data.data[0].contact_usetime
                    product_item.contact_model = res.data.data[0].contact_model
                    product_item.contact_material = res.data.data[0].contact_material
                    break;
                  case 6:
                    product_item.caresolution_brand = res.data.data[0].caresolution_brand
                    product_item.caresolution_function = res.data.data[0].caresolution_function

                    product_item.caresolution_rule = res.data.data[0].caresolution_rule
                    product_item.caresolution_model = res.data.data[0].caresolution_model
                    product_item.caresolution_material = res.data.data[0].caresolution_material
                    break;
                  case 7:
                    product_item.accessory_brand = res.data.data[0].accessory_brand
                    product_item.accessory_function = res.data.data[0].accessory_function

                    product_item.accessory_size = res.data.data[0].accessory_size
                    product_item.accessory_model = res.data.data[0].accessory_model
                    product_item.accessory_material = res.data.data[0].accessory_material
                    break;
                }


                var chongfu = false;
                for (var key in products_add) {
                  if (product_item.degree_id == products_add[key].degree_id) {
                    products_add[key].number = products_add[key].number + 1
                    chongfu = true
                  }
                }
                ...
                //   })
                //   wx.setStorageSync('goodsNum_cache', goodsNum)
                //   wx.setStorage({
                //     key: "products_add",
                //     data: products_add
                //   })
                //   return
                // } else {
                //   products_add[product_item.degree_id] = product_item
                //   wx.setStorage({
                //     key: "products_add",
                //     data: products_add
                //   })
                ...
                wx.setStorageSync('goodsNum_cache', that.data.goodsNum)
              }else if(res.data.code==201){//已销售
                if (that.data.goodsNum==0){//购物车中无其他商品
                wx.showToast({
                  title: '该商品已销售',
                  image: '../images/warn.png'
                })
  ...
  add_product: function (e) {
    ...
    if (products_add['g'+degree_id]){
      products_add['g' + degree_id].number = products_add['g' + degree_id].number + 1
    }else{
